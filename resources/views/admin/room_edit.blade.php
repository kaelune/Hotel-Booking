                ...
                <div class="card-body">
                    <form action="{{ route('admin_room_update',$room_data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="mb-4">
                                    <label class="form-label">Existing Featured Photo</label><br>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control snote" name="description" cols="40" rows="10">{!! $room_data->description !!}</textarea>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="col-md-8">
                                    <iframe class="w_250 h_180" width="560" height="315" src="https://www.youtube.com/embed/{{ $room_data->video_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></td>
                                    </div>
                                </div>
                                <div class="mb-4">
