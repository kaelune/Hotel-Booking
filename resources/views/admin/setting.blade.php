                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Existing Logo</label><br>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Existing Favicon</label><br>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control h_50" name="footer_address" cols="30" rows="10">{{ $setting_data->footer_address }}</textarea>
                                </div>
                                <div class="mb-4">
