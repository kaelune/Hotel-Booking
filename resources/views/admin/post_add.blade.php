                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control h_100" name="short_content" cols="40" rows="10">{{ old('short_content') }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Content</label>
                                    <textarea class="form-control snote" name="content" cols="40" rows="10">{{ old('content') }}</textarea>
                                </div>
                                <div class="mb-4">
