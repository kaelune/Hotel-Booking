                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tr>
                                ...
                                <td class="pt_10 pb_10">
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $i }}">Detail</button>
                                    <a href="{{ route('admin_room_gallery',$row->id) }}" class="btn btn-success">Room Photo</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row bdb1 pt_10 mb_0">
                                                ...
                                                <div class="col-md-8">Rp {{ $row->size }}</div>
                                            </div>
                                            <div class="form-group row bdb1 pt_10 mb_0">
                                            ...
                                            <div class="form-group row bdb1 pt_10 mb_0">
                                                <div class="col-md-4"><label class="form-label">Video Preview</label></div>
                                                <div class="col-md-8">
                                                    <iframe class="w_250 h_180" width="560" height="315" src="https://www.youtube.com/embed/{{ $row->video_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></td>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
