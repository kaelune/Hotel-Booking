        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 checkout-left mb_30">
                ...
                <div class="stripe mt_20">
                    ...
                    $stripe_publishable_key='pk_test_51MYa5lIdMULlGiHzQbyOWZ58iZyDTQrdZZ4n67Fs5gMIOxngOw78Nv0HEmp5DazbMZeZBYLhy30qhWMizOMiD2MC00w9afRAiJ';
                    @endphp
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                for($i=0;$i<count($arr_cart_room_id);$i++)
                                {
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('room_detail',$arr_cart_room_id[$i]) }}" class="room-name">{{ $room_data->name }}</a>
                                            <br>
