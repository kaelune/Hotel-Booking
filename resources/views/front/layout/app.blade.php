                ...
                <div class="row">
                    ...
                    <div class="col-md-6 right-side">
                        <ul class="right">
                            ...
                            <li class="menu"><a href="{{ route('cart') }}">{{ $global_page_data->cart_heading }} @if(session()->get('cart_room_id'))<sup>{{ count(session()->get('cart_room_id')) }}</sup>@endif</a></li>
                            @endif
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <ul class="social">
                                ...
                                <li><a href="{{ $global_setting_data->youtube }}"><i class="fa fa-youtube"></i></a></li>
                                @endif
