...
class CustomerAuthController extends Controller
{
    ...
    public function signup_submit(Request $request){
        ...
        $message = 'Click the link below to confirm signup process : <br>';
        ...
        return redirect()->back()->with('success', 'Please check your email for the link to complete sign up');
    ...
    public function signup_verify($email,$token){
        ...
        if($customer_data){
            ...
            return redirect()->route('customer_login')->with('success', 'Your account has been signed up succesfuly!');
        } else {
