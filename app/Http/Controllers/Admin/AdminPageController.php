...
class AdminPageController extends Controller
{
    ...
    public function about_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page about is updated successfully.');
    }
    ...
    public function terms_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page terms is updated successfully.');
    }
    ...
    public function privacy_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page privacy is updated successfully.');
    }
    ...
    public function contact_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page contact is updated successfully.');
    }
    ...
    public function photo_gallery_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', ' Page Photo gallery is updated successfully.');
    }
    ...
    public function video_gallery_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Video gallery is updated successfully.');
    }
    public function faq(){
        $page_data = Page::where('id',1)->first();
    ...
    public function faq_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page FAQ is updated successfully.');
    }
    ...
    public function blog_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Blog is updated successfully.');
    }
    ...
    public function room_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Room is updated successfully.');
    }
    ...
    public function cart_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Cart is updated successfully.');
    }
    ...
    public function checkout_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Checkout is updated successfully.');
    }
    ...
    public function payment_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Payment is updated successfully.');
    }
    ...
    public function signup_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Sign Up is updated successfully.');
    }
    ...
    public function signin_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Sign In is updated successfully.');
    }
    ...
    public function forget_password_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Forget Password is updated successfully.');
    }
    ...
    public function reset_password_update(Request $request){
        ...
        $obj->update();
        return redirect()->back()->with('success', 'Page Reset Password is updated successfully.');
    }
}
