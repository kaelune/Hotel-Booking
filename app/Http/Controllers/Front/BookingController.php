...
class BookingController extends Controller
{
    public function cart_submit(Request $request){
        ...
        if($cnt == 0){
            return redirect()->back()->with('error', 'This room is not available because maximum limit of the room');
        ...
        return redirect()->back()->with('success', 'Room is added to cart.');
    ...
    public function cart_delete($id){
        ...
        return redirect()->back()->with('success', 'Cart item is deleted succesfully');
    }

    public function checkout(Request $request){
        if(!Auth::guard('customer')->check()){
            return redirect()->back()->with('error', 'You must login to go to checkout page');
        }

        if(!session()->has('cart_room_id')){
            return redirect()->back()->with('error', 'No item in the cart!');
        }
    ...
    public function payment(Request $request){
        if(!Auth::guard('customer')->check()){
            return redirect()->back()->with('error', 'You must login to go to payment page');
        }
    ...
    public function paypal($final_price){
        ...
        $client = 'AfTosFS3T4A0kFxN4noQp1pt2pJE7J8fmXJHIrnZBgUGmCL_ZD26KB_mAJz1ISpBaCBJV95eLDyqqN8W';
        $secret = 'EKQnjWZp0TleYXTUPwZuccjmzQLIA-VRVrI6B-wAuF8xjETAqrJUoXq4mJ40afqAflZVzwskTjGamHeE';
        ...
        if($result->state == 'approved')
        {
            ...
            $obj->booking_date = date('H:i D, d M Y');
            ...
            $subject = 'New Order for Xentience Hotel';
            $message = 'You have made an order for this hotel. The booking information is given below:  <br>';
            $message .= '<br>Order Number : ' . $order_no;
            $message .= '<br>Transaction ID : ' . $result->id;
            $message .= '<br>Booking date : ' . date('H:i l, d F Y');
            $message .= '<br>Payment Method : Paypal' ;
            $message .= '<br>Paid Amount : $' . $paid_amount.'<br>';
            ...
            return redirect()->route('home')->with('success', 'Payment has been paid succesfully. Please chack your email for booking information');
    ...
    public function stripe(Request $request, $final_price){
        $stripe_secret_key='sk_test_51MYa5lIdMULlGiHzA8bjGa4HF2vEJoDqxaFTCxhydjnlvwNyTze9rX91fglnVHV11wzXgH7PdlDqtOPnb1ejm0rI00KTLipslu';
        ...
        $message .= '<br>Paid Amount : $' . $final_price.'<br>';
